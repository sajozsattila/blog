...
# set timeout for data prerpocessing
import datetime
import torch.distributed as dist
dist.init_process_grop(backend="nccl", init_method="env://", timout=datetime.timedelta(hours=3))
...
class ScriptArguments:
    ...
    num_proc: Optional[int] = field(default=100, metadata={"help": "number of process"})
...
if __name__ == "__main__":
    ...
    model = AutoModelForCausalLM.from_pretrained(
        ...
        quantization_config=BitsAndBytesConfig(load_in_4bit=script_args.load_in_4bit),
